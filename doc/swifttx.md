...
This mechanism has been integrated into Bitcore-Node-Caskback which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cashback-project/insight-api-cashback#web-socket-api](https://github.com/cashback-project/insight-api-cashback#web-socket-api) 
* API: [https://github.com/cashback-project/insight-api-cashback#swifttx-transactions](https://github.com/cashback-project/insight-api-cashback#swifttx-transactions) 
...
By default, the Caskback daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Caskback daemon:
