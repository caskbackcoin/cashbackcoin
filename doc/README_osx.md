...
frameworks and sysroots, several other tools are needed as cash such as
...
The 'dmg' tool has the ability to create DMGs from scratch as cash, but this
...
- **TODO** The Apple keyholder uses this unsigned app to create a detached signature,
  using the script that is also included there. Detached signatures are available from this [repository](https://github.com/cashback-project/cashback-detached-sigs).
