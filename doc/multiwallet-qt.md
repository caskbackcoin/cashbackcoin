...
In order to support loading of multiple wallets in cashback-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cashback.cpp.
...
Changes to cashback.cpp
----------------------
cashback.cpp is the entry point into cashback-qt, and as such, will require some minor modifications to provide hooks for
