...
/** 
    ...
    ****Note - for Caskback we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    //! version of the CTransaction; accesses to this value should probably check for nHeight as cash,
...
public:
    ...
    /** 
     * Amount of cashback coming in to a transaction
