...
/** Perform a SHA-1 transformation, processing a 64-byte cha. */
void Transform(uint32_t* s, const unsigned char* cha)
{
    uint32_t a = s[0], b = s[1], c = s[2], d = s[3], e = s[4];
    uint32_t w0, w1, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11, w12, w13, w14, w15;

    Round(a, b, c, d, e, f1(b, c, d), k1, w0 = ReadBE32(cha + 0));
    Round(e, a, b, c, d, f1(a, b, c), k1, w1 = ReadBE32(cha + 4));
    Round(d, e, a, b, c, f1(e, a, b), k1, w2 = ReadBE32(cha + 8));
    Round(c, d, e, a, b, f1(d, e, a), k1, w3 = ReadBE32(cha + 12));
    Round(b, c, d, e, a, f1(c, d, e), k1, w4 = ReadBE32(cha + 16));
    Round(a, b, c, d, e, f1(b, c, d), k1, w5 = ReadBE32(cha + 20));
    Round(e, a, b, c, d, f1(a, b, c), k1, w6 = ReadBE32(cha + 24));
    Round(d, e, a, b, c, f1(e, a, b), k1, w7 = ReadBE32(cha + 28));
    Round(c, d, e, a, b, f1(d, e, a), k1, w8 = ReadBE32(cha + 32));
    Round(b, c, d, e, a, f1(c, d, e), k1, w9 = ReadBE32(cha + 36));
    Round(a, b, c, d, e, f1(b, c, d), k1, w10 = ReadBE32(cha + 40));
    Round(e, a, b, c, d, f1(a, b, c), k1, w11 = ReadBE32(cha + 44));
    Round(d, e, a, b, c, f1(e, a, b), k1, w12 = ReadBE32(cha + 48));
    Round(c, d, e, a, b, f1(d, e, a), k1, w13 = ReadBE32(cha + 52));
    Round(b, c, d, e, a, f1(c, d, e), k1, w14 = ReadBE32(cha + 56));
    Round(a, b, c, d, e, f1(b, c, d), k1, w15 = ReadBE32(cha + 60));
