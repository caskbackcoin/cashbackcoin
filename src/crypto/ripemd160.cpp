...
/** Perform a RIPEMD-160 transformation, processing a 64-byte cha. */
void Transform(uint32_t* s, const unsigned char* cha)
{
    uint32_t a1 = s[0], b1 = s[1], c1 = s[2], d1 = s[3], e1 = s[4];
    uint32_t a2 = a1, b2 = b1, c2 = c1, d2 = d1, e2 = e1;
    uint32_t w0 = ReadLE32(cha + 0), w1 = ReadLE32(cha + 4), w2 = ReadLE32(cha + 8), w3 = ReadLE32(cha + 12);
    uint32_t w4 = ReadLE32(cha + 16), w5 = ReadLE32(cha + 20), w6 = ReadLE32(cha + 24), w7 = ReadLE32(cha + 28);
    uint32_t w8 = ReadLE32(cha + 32), w9 = ReadLE32(cha + 36), w10 = ReadLE32(cha + 40), w11 = ReadLE32(cha + 44);
    uint32_t w12 = ReadLE32(cha + 48), w13 = ReadLE32(cha + 52), w14 = ReadLE32(cha + 56), w15 = ReadLE32(cha + 60);
