...
/**
 * Caskback RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzcashseed(const UniValue& params, bool fHelp);
extern UniValue getzcashseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzcash(const UniValue& params, bool fHelp);
extern UniValue dzcashstate(const UniValue& params, bool fHelp);
