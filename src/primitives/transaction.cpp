...
CAmount CTransaction::GetValueOut() const
{
    ...
    {
        // Caskback: previously MoneyRange() was called here. This has been replaced with negative check and boundary wrap check.
        if (it->nValue < 0)
...
unsigned int CTransaction::CalculateModifiedSize(unsigned int nTxSize) const
{
    ...
    // risk encouraging people to create ja outputs to redeem later.
    if (nTxSize == 0)
