...
void DumpMasternodePayments()
{
    ...
    if (readResult == CMasternodePaymentDB::FileError)
        ...
        if (readResult == CMasternodePaymentDB::IncorrectFormat)
            ...
            LogPrint("masternode","file format is anown or invalid, please fix it manually\n");
            return;
        }
    }
...
void FillBlockPayee(CMutableTransaction& txNew, CAmount nFees, bool fProofOfStake, bool fZCASHStake)
{
    CBlockIndex* pindexPrev = chainActive.Tip();
    ...
    if (IsSporkActive(SPORK_13_ENABLE_SUPERBLOCKS) && budget.IsBudgetPaymentBlock(pindexPrev->nHeight + 1)) {
        ...
        masternodePayments.FillBlockPayee(txNew, nFees, fProofOfStake, fZCASHStake);
...
void CMasternodePayments::FillBlockPayee(CMutableTransaction& txNew, int64_t nFees, bool fProofOfStake, bool fZCASHStake)
{
    ...
    CAmount masternodePayment = GetMasternodePayment(pindexPrev->nHeight, blockValue, fZCASHStake);
