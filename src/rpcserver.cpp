...
string CRPCTable::help(string strCommand) const
{
    ...
    if (strRet == "")
        strRet = strprintf("help: anown command: %s\n", strCommand);
...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Caskback server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Caskback server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Caskback features */
        {"cashback", "masternode", &masternode, true, true, false},
        {"cashback", "listmasternodes", &listmasternodes, true, true, false},
        {"cashback", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cashback", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cashback", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"cashback", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"cashback", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"cashback", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cashback", "masternodedebug", &masternodedebug, true, true, false},
        {"cashback", "startmasternode", &startmasternode, true, true, false},
        {"cashback", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cashback", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cashback", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cashback", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cashback", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cashback", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cashback", "mnbudget", &mnbudget, true, true, false},
        {"cashback", "preparebudget", &preparebudget, true, true, false},
        {"cashback", "submitbudget", &submitbudget, true, true, false},
        {"cashback", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cashback", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cashback", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cashback", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cashback", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cashback", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cashback", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cashback", "checkbudgets", &checkbudgets, true, true, false},
        {"cashback", "mnsync", &mnsync, true, true, false},
        {"cashback", "spork", &spork, true, true, false},
        {"cashback", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzcashseed", &getzcashseed, false, false, true},
        {"zerocoin", "setzcashseed", &setzcashseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzcash", &searchdzcash, false, false, true},
        {"zerocoin", "dzcashstate", &dzcashstate, false, false, true}
...
{
    return "> cashback-cli " + methodname + " " + args + "\n";
}
