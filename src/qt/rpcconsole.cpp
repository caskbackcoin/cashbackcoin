...
// Copyright (c) 2015-2018 The Caskback developers
                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCASHPathCustom = GetArg("-zcashbackuppath", "");
    ...
    if(!strzCASHPathCustom.empty()) {
        ui->wallet_customzcashbackuppath->setText(QString::fromStdString(strzCASHPathCustom));
        ui->wallet_customzcashbackuppath_label->setVisible(true);
        ui->wallet_customzcashbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzCASHPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Caskback RPC console.") + "<br>" +
