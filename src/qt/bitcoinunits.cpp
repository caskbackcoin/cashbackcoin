...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case CASH:
        return QString("cashback");
    case mCASH:
        return QString("mcashback");
    case uCASH:
        return QString::fromUtf8("ucashback");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case CASH:
            return QString("CASH");
        case mCASH:
            return QString("mCASH");
        case uCASH:
            return QString::fromUtf8("μCASH");
        default:
            return QString("???");
        }
    } else {
