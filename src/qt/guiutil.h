...
/** Utility functions used by the Caskback Qt UI.
 */
namespace GUIUtil
{
...
// Render Caskback addresses in monospace font
...
// Parse "cashback:" URI into recipient object, return true on successful parsing
