                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Caskback") + " - ";
#ifdef ENABLE_WALLET
    ...
    if (curStyle == "QWindowsStyle" || curStyle == "QWindowsXPStyle") {
        progressBar->setStyleSheet("QProgressBar { background-color: #F8F8F8; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::cha { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #00CCFF, stop: 1 #33CCFF); border-radius: 7px; margin: 0px; }");
    }
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Caskback address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cashback: URIs)"));
    ...
    privacyAction = new QAction(QIcon(":/icons/privacy"), tr("&Caskback"), this);
    privacyAction->setStatusTip(tr("Access the site and get all the information about CaskbackCoin"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Caskback"), this);
    aboutAction->setStatusTip(tr("Show information about Caskback"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Caskback"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Caskback addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Caskback addresses"));
    ...
    openAction->setStatusTip(tr("Open a Caskback: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gentaium Core help message to get a list with possible Caskback command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Caskback client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Caskback network", "", count));
}
...
{
    QString strTitle = tr("Caskback"); // default title
