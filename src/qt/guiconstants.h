...
/* Caskback GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Caskback"
#define QAPP_ORG_DOMAIN "cashback.foundation"
#define QAPP_APP_NAME_DEFAULT "Caskback"
#define QAPP_APP_NAME_TESTNET "Caskback-Qt-testnet"
