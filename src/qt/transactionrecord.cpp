...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zcashTracker->HasMintTx(hash))) {
            //zCASH stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZCASH;
...
bool IsZCASHType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZCASH:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZCASH || type == TransactionRecord::MNReward) {
