...
#   c) node1 mines 32 blocks, so now node 0 has 60001cash, node 1 has 4250cash, node2 has none.
#   d) node0 sends 601 cash to node2, in two transactions (301 cash, then 300 cash).
