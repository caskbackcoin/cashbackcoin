...
RESOURCES += src/qt/cashback.qrc src/qt/cashback_locale.qrc

TRANSLATIONS += src/qt/locale/cashback_bg.ts \
                src/qt/locale/cashback_de.ts \
                src/qt/locale/cashback_en.ts \
                src/qt/locale/cashback_es.ts \
                src/qt/locale/cashback_fi.ts \
                src/qt/locale/cashback_fr.ts \
                src/qt/locale/cashback_it.ts \
                src/qt/locale/cashback_ja.ts \
                src/qt/locale/cashback_pl.ts \
                src/qt/locale/cashback_pt.ts \
                src/qt/locale/cashback_ru.ts \
                src/qt/locale/cashback_sk.ts \
                src/qt/locale/cashback_sv.ts \
                src/qt/locale/cashback_vi.ts \
                src/qt/locale/cashback_zh_CN.ts \
                src/qt/locale/cashback_zh_TW.ts
